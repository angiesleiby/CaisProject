...
public class ViewDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServerURL = "https://getatyourservice.info/assignment/view_all.php";

        ListView = (ListView)findViewById(R.id.listView);

        new GetHttpResponse(ViewDelete.this).execute();
        ...
        ListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ViewDelete.this,DeleteActivity.class);
